...
/**
 * HANDSHAKE Option
 * EDNS Handshake Option ("Experimental")
 * @see https://hsd-dev.org/HIPs/proposals/XXXX/
 */

class HANDSHAKEOption extends OptionData {
  constructor() {
    super();
    this.hns = 0;
  }
...
optsByVal = {
  ...
  [options.HANDSHAKE]: HANDSHAKEOption
};
...
function readOption(code, br) {
  ...
  switch (code) {
    ...
    case options.HANDSHAKE:
      return HANDSHAKEOption.read(br);
    default:
